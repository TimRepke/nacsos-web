...
export class AnnotationsService {
  ...
  public static getSchemeDefinitionsForProjectApiAnnotationsSchemesListGet(
    data: $OpenApiTs["/api/annotations/schemes/list"]["get"]["req"],
    options?: Partial<AxiosRequestConfig>,
  ): CancelablePromise<ApiResult<$OpenApiTs["/api/annotations/schemes/list"]["get"]["res"][200]>> {
  ...
  public static getAnnotationSchemeFingerprintsApiAnnotationsSchemesFingerprintsGet(
    data: $OpenApiTs["/api/annotations/schemes/fingerprints"]["get"]["req"],
    options?: Partial<AxiosRequestConfig>,
  ): CancelablePromise<ApiResult<$OpenApiTs["/api/annotations/schemes/fingerprints"]["get"]["res"][200]>> {
    const { xProjectId, merged } = data;
    return __request(OpenAPI, {
      method: "GET",
...
export class ItemService {
  public static getItemVariantsApiItemVariantsItemIdGet(
    data: $OpenApiTs["/api/item/variants/{item_id}"]["get"]["req"],
    options?: Partial<AxiosRequestConfig>,
  ): CancelablePromise<ApiResult<$OpenApiTs["/api/item/variants/{item_id}"]["get"]["res"][200]>> {
    const { itemId, xProjectId } = data;
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static getItemInfoApiItemInfoItemIdGet(
    data: $OpenApiTs["/api/item/info/{item_id}"]["get"]["req"],
    options?: Partial<AxiosRequestConfig>,
  ): CancelablePromise<ApiResult<$OpenApiTs["/api/item/info/{item_id}"]["get"]["res"][200]>> {
    const { itemId, xProjectId } = data;
    return __request(OpenAPI, {
      method: "GET",
