...
import type { AssignmentScopeRandomConfigOutput } from './AssignmentScopeRandomConfigOutput';
import type { AssignmentScopeRandomWithExclusionConfigOutput } from './AssignmentScopeRandomWithExclusionConfigOutput';
 ...
 *
 */
export type AssignmentScopeModelOutput = {
  assignment_scope_id: (string | null);
  annotation_scheme_id: string;
  time_created: (string | null);
  name: string;
  description: (string | null);
  config: (AssignmentScopeRandomWithExclusionConfigOutput | AssignmentScopeRandomConfigOutput | null);
