...
import type { ImportConfigTwitterInput } from './ImportConfigTwitterInput';
...
export type ImportModelInput = {
  ...
  config?: (ImportConfigTwitterInput | ImportConfigJSONL | ImportConfigWoS | ImportConfigScopus | null);
};
