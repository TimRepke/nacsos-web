...
import type { AnnotationSchemeLabelOutput } from './AnnotationSchemeLabelOutput';
 ...
 *
 */
export type AnnotationSchemeModelOutput = {
  ...
  labels: Array<AnnotationSchemeLabelOutput>;
};
