...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "query", "symbols": ["query$subexpression$1", {"literal":":"}, "_", "dois"], "postprocess": (d) => ({ field: 'doi',         values: d[3]             })},
    {"name": "query$subexpression$2", "symbols": [/[oO]/, /[aA]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "query", "symbols": ["query$subexpression$2", {"literal":":"}, "_", "oa_ids"], "postprocess": (d) => ({ field: 'openalex_id', values: d[3]             })},
    {"name": "query$subexpression$3", "symbols": [/[iI]/, /[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "query", "symbols": ["query$subexpression$3", {"literal":":"}, "_", "uuids"], "postprocess": (d) => ({ field: 'item_id',     values: d[3]             })},
    {"name": "query", "symbols": ["SRC", {"literal":":"}, "_", "dqstring"], "postprocess": (d) => ({ field: 'source',      value:  d[3]             })},
    ...
    {"name": "query", "symbols": ["query", "__", "AND", "__", "query"], "postprocess": (d) => ({ 'and_': [d[0], d[4]]                            })},
    {"name": "query", "symbols": ["query", "__", "OR", "__", "query"], "postprocess": (d) => ({ 'or_':  [d[0], d[4]]                            })},
    ...
    {"name": "dois", "symbols": ["DOI"], "postprocess": (d) => [d[0]]},
    {"name": "dois", "symbols": ["dois", "_", {"literal":","}, "_", "DOI"], "postprocess": (d) => d[0].concat([d[4]])},
    ...
    {"name": "oa_ids", "symbols": ["OA_ID"], "postprocess": (d) => [d[0]]},
    {"name": "oa_ids", "symbols": ["oa_ids", "_", {"literal":","}, "_", "OA_ID"], "postprocess": (d) => d[0].concat([d[4]])},
