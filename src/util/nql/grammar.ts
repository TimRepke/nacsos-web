...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "query", "symbols": ["query$subexpression$1", {"literal":":"}, "_", "dois"], "postprocess": (d) => ({ filter: "field_mul", field: "doi",         values: d[3]               })},
    {"name": "query$subexpression$2", "symbols": [/[oO]/, /[aA]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "query", "symbols": ["query$subexpression$2", {"literal":":"}, "_", "oa_ids"], "postprocess": (d) => ({ filter: "field_mul", field: "openalex_id", values: d[3]               })},
    {"name": "query$subexpression$3", "symbols": [/[iI]/, /[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "query", "symbols": ["query$subexpression$3", {"literal":":"}, "_", "uuids"], "postprocess": (d) => ({ filter: "field_mul", field: "item_id",     values: d[3]               })},
    {"name": "query", "symbols": ["SRC", {"literal":":"}, "_", "dqstring"], "postprocess": (d) => ({ filter: "field", field: "source",      value:  d[3], comp: "LIKE" })},
    {"name": "query", "symbols": ["META", {"literal":":"}, "_", "meta_clause"], "postprocess": (d) => ({ ...d[3]                                        })},
    ...
    {"name": "query", "symbols": ["query$string$1", "__", "query"], "postprocess": (d) => ({ filter: "sub", "not_": d[2]                    })},
    ...
    {"name": "assigned_clause$subexpression$5", "symbols": [/[iI]/, /[sS]/, {"literal":" "}, /[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[aA]/, /[sS]/, /[sS]/, /[iI]/, /[gG]/, /[nN]/, /[eE]/, /[dD]/, {"literal":" "}, /[wW]/, /[iI]/, /[tT]/, /[hH]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "assigned_clause", "symbols": ["assigned_clause$subexpression$5", "__", "UUID"], "postprocess": (d) => ({ filter: "assignment", mode: 8, scheme: d[2] })},
    {"name": "assigned_clause$subexpression$6", "symbols": [/[iI]/, /[sS]/, {"literal":" "}, /[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[aA]/, /[sS]/, /[sS]/, /[iI]/, /[gG]/, /[nN]/, /[eE]/, /[dD]/, {"literal":" "}, /[iI]/, /[gG]/, /[nN]/, /[oO]/, /[rR]/, /[iI]/, /[nN]/, /[gG]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "assigned_clause", "symbols": ["assigned_clause$subexpression$6", "__", "uuids"], "postprocess": (d) => ({ filter: "assignment", mode: 5, scopes: d[2] })},
    {"name": "assigned_clause$subexpression$7", "symbols": [/[iI]/, /[sS]/, {"literal":" "}, /[aA]/, /[sS]/, /[sS]/, /[iI]/, /[gG]/, /[nN]/, /[eE]/, /[dD]/, {"literal":" "}, /[wW]/, /[iI]/, /[tT]/, /[hH]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "assigned_clause", "symbols": ["assigned_clause$subexpression$7", "__", "UUID"], "postprocess": (d) => ({ filter: "assignment", mode: 6, scheme: d[2] })},
    {"name": "assigned_clause$subexpression$8", "symbols": [/[iI]/, /[sS]/, {"literal":" "}, /[aA]/, /[sS]/, /[sS]/, /[iI]/, /[gG]/, /[nN]/, /[eE]/, /[dD]/, {"literal":" "}, /[bB]/, /[uU]/, /[tT]/, {"literal":" "}, /[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[wW]/, /[iI]/, /[tT]/, /[hH]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "assigned_clause", "symbols": ["assigned_clause$subexpression$8", "__", "UUID"], "postprocess": (d) => ({ filter: "assignment", mode: 7, scheme: d[2] })},
    ...
    {"name": "meta_clause", "symbols": ["KEY", "__", "meta_clause$subexpression$1", "__", "dqstring"], "postprocess": (d) => ({ filter: "meta_str",  value_type: "str",  field: d[0], comp: "LIKE", value: d[4] })},
