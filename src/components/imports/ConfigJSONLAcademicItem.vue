<template>
  <div class="m-2">
    <div class="row">
      <div class="col-xxl-7">
        <h4>AcademicItem file import</h4>
        <p class="text-muted">
          Upload a file, where each line has the exact same encoding for academic items in our database.
          In other words, each line in this file is produced by <code>nacsos_data.models.items.AcademicItemModel.dump_model_json()</code>.
        </p>
      </div>
    </div>
    <div class="row">
