...
<script lang="ts">
import { callNextAnnotationItemEndpoint } from '@/plugins/api/annotations';
...
import AnnotationLabel from '@/components/annotations/AnnotationLabel.vue';
...
export default {
  ...
  async setup() {
    ...
    const response = await callNextAnnotationItemEndpoint({ projectId: currentProjectId });
