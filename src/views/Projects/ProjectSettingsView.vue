...
type PermissionKeys = 'owner' // eslint-disable-next-line @typescript-eslint/indent
...
type Permissions = Pick<UserPermission, PermissionKeys>;
...
export default {
  ...
  data(): SettingsData {
    return {
      ...
      hints: {
        owner: 'The user will have complete and unrestricted access to this project. '
          + 'This includes the ability to update access permissions.',
